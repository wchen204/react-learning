...
export default function Signup() {
    ...
    // because we have multiple inputs, and we need to manage the state of each input.
    ...
    function handleSubmit(event) {
        ...
        const acquisitionChannel = formData.getAll('acquisition'); // get all the acquisition channels.
